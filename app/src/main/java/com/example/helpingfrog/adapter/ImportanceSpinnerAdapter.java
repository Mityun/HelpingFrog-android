...
public class ImportanceSpinnerAdapter extends ArrayAdapter<Importance> {

    public ImportanceSpinnerAdapter(@NonNull Context context, @NonNull List<Importance> objects) {
